...
public class MyMessages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(mContext, " My messages " + "a7a", Toast.LENGTH_SHORT).show();
...
/*
                            String contactName = response.body().getContactName();
                            String contactID = response.body().getContactID();*/
