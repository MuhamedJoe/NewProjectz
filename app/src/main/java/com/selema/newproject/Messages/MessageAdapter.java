...
import com.selema.newproject.MainActivity;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.MyViewHolder> {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            i.putExtra("senderphone", inbox.get(position).getPhoneNumber());
            i.putExtra("senderphone", inbox.get(position).getPhoneNumber());
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.sender.setText(inboxes.getName().toString());
        holder.msgtime.setText(messages.get(0).getMessageTime().toString());
